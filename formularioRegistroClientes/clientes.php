<form>
	<div class="border border-secondary p-3">
	  <p class="display-4 text-center">Datos del cliente</p>

	    <div class="form-group row">
	    	<label for="nombre cliente" class="col-md-4 col-form-label">Nombre del cliente</label>
	      	<div class="col-md-8">
		    	<input type="text" class="form-control" id="nombre_cliente" placeholder="Ingrese nombre del cliente" required>  
		    </div>
	  </div>

        <div class="form-group row">
	    	<label for="direccion_cliente" class="col-md-4 col-form-label">Dirección</label>
		    <div class="col-md-8">
		      <input type="text" class="form-control" id="direccion_cliente" placeholder="Ingrese direccion del cliente" required>
		    </div>
	    </div>

        
	    <div class="form-group row">
	    	<label for="poblacion_cliente" class="col-md-4 col-form-label">Población</label>
		    <div class="col-md-8">
		      <input type="text" class="form-control" id="poblacion_cliente" placeholder="Ingrese poblacion" required>
		    </div>
	    </div>

	     <div class="form-group row">
	    	<label for="provincia_cliente" class="col-md-4 col-form-label">Provincia</label>
		    <div class="col-md-8">
		      <input type="text" class="form-control" id="provincia_cliente" placeholder="Ingrese provincia" required>
		    </div>
	    </div>
	    ...
	    <div class="form-group row">
          ...
          <div class="col-md-8 text-center">
            <select class="form-control " name="pais" id="pais">
					...
					<option value="45" selected="selected">Colombia</option>
		...
		<div class="form-group row">
		    ...
		    <div class="col-md-8">
		      <input type="email" class="form-control" id="email_cliente" placeholder="Ingrese email" required>
		    </div>
	    </div>
	    ...
	    <div class="form-group row">
		    ...
		    <div class="col-md-8">
		      <input type="text" class="form-control" id="telefono_cliente" placeholder="Ingrese telefono" required>
		    </div>
	    </div>
		...
		<div class="form-group row">
              ...
              <div class="col-md-8 text-center">
                <select class="form-control" id="servicios_contratar" name="servicios_contratar">
                  ...
                  <option>Alquiler de carro</option>
                  <option>Crucero</option>
                  <option>Toures</option>
                  <option>Evento social</option>
                  <option>Evento coroporativo</option>
                  <option>Alquiler transporte nautico</option>
                  <option>Alquiler transporte aereo</option>
                  <option>Transporte terrestre (tren, bus)</option>
			...
			<div class="row">
				...
				<div class="col-md-3">
			    	<input type="number" class="form-control" id="adultos" placeholder="Numero de adultos" required>
				</div>
				<div class="col-md-3">
